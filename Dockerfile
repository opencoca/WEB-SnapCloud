...
RUN cd app \
  && wget https://github.com/opencoca/STARTR-Snap/archive/refs/tags/v10.4.6.2.zip \
    -O STARTR-Snap-v10.4.6.2.zip \
  && unzip STARTR-Snap-v10.4.6.2.zip \
  && rm STARTR-Snap-v10.4.6.2.zip \
  && rm -rf /app/snap \
  && mv /app/STARTR-Snap-10.4.6.2 /app/snap
