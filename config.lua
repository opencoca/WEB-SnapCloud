...
config({'development', 'staging', 'production', 'test'}, {
    ...
    mail_from_name = "Codzey Snap!Cloud",
    mail_from = "noreply@codezy.org",
    mail_footer = "<br/><br/><p><small>Please do not reply to this email. This message was automatically generated by the Codzey Snap!Cloud. To contact an actual human being, please write to <a href='mailto:contact@codezy.org'>contact@codzey.org</a></small></p>",
